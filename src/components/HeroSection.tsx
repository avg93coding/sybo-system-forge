  ...
  return (
    <section id="hero" className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0">
        {/* Floating Data Nodes with improved positioning */}
      ...
      <div className="relative z-20 max-w-7xl mx-auto sybo-mobile-padding text-center py-20">
        ...
        <div className="sybo-fade-in">
          ...
          <h1 className="sybo-hero-title-responsive font-bold sybo-heading mb-4 sm:mb-6 leading-tight">
            <span className="text-sybo-text">{t('hero.title')}</span>
            <br />
            <span className="sybo-gradient-text">{t('hero.title.highlight')}</span>
          </h1>

          <p className="sybo-description-responsive text-sybo-text-muted max-w-3xl mx-auto leading-relaxed mb-8 sm:mb-12">
            {t('hero.description')}
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-12 sm:mb-16">
            <Button 
              ...
              className="sybo-btn-primary sybo-mobile-button w-full sm:w-auto px-8 py-4 rounded-full font-semibold group shadow-2xl transform hover:scale-105 transition-all duration-300"
            >
            ...
            <Button 
              ...
              className="sybo-btn-ghost sybo-mobile-button w-full sm:w-auto px-8 py-4 rounded-full font-semibold group"
            >
        ...
        <div className="sybo-scale-in" style={{ animationDelay: '0.5s' }}>
          <div className="relative max-w-4xl mx-auto">
            <div className="sybo-glass rounded-xl sm:rounded-2xl sybo-card-mobile backdrop-blur-xl border border-sybo-border/20 sybo-pulse-glow">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-6">
                {/* Health Analytics */}
                <div className="bg-sybo-surface/50 rounded-lg sm:rounded-xl p-4 sm:p-6 sybo-floating hover:scale-105 transition-transform duration-300">
                  ...
                  <div className="space-y-2">
                    <div className="h-1.5 sm:h-2 bg-sybo-surface rounded-full overflow-hidden">
                      <div className="h-full bg-sybo-neon w-3/4 rounded-full animate-pulse"></div>
                    </div>
                    <div className="h-1.5 sm:h-2 bg-sybo-surface rounded-full overflow-hidden">
                      <div className="h-full bg-sybo-neon w-1/2 rounded-full animate-pulse" style={{ animationDelay: '0.5s' }}></div>
                    </div>
                    <div className="h-1.5 sm:h-2 bg-sybo-surface rounded-full overflow-hidden">
                      <div className="h-full bg-sybo-neon w-5/6 rounded-full animate-pulse" style={{ animationDelay: '1s' }}></div>
                    </div>
                  </div>
                </div>

                {/* Industrial Automation */}
                <div className="bg-sybo-surface/50 rounded-lg sm:rounded-xl p-4 sm:p-6 sybo-floating hover:scale-105 transition-transform duration-300" style={{ animationDelay: '1s' }}>
                  <div className="flex items-center space-x-2 sm:space-x-3 mb-3 sm:mb-4">
                  ...
                  <div className="space-y-2">
                    <div className="h-1.5 sm:h-2 bg-sybo-surface rounded-full overflow-hidden">
                      <div className="h-full bg-sybo-sapphire w-4/5 rounded-full animate-pulse"></div>
                    </div>
                    <div className="h-1.5 sm:h-2 bg-sybo-surface rounded-full overflow-hidden">
                      <div className="h-full bg-sybo-sapphire w-2/3 rounded-full animate-pulse" style={{ animationDelay: '0.5s' }}></div>
                    </div>
                    <div className="h-1.5 sm:h-2 bg-sybo-surface rounded-full overflow-hidden">
                      <div className="h-full bg-sybo-sapphire w-3/4 rounded-full animate-pulse" style={{ animationDelay: '1s' }}></div>
                    </div>
                  </div>
                </div>

                {/* Automation Systems */}
                <div className="bg-sybo-surface/50 rounded-lg sm:rounded-xl p-4 sm:p-6 sybo-floating hover:scale-105 transition-transform duration-300" style={{ animationDelay: '2s' }}>
                  <div className="flex items-center space-x-2 sm:space-x-3 mb-3 sm:mb-4">
                  ...
                  <div className="space-y-2">
                    <div className="h-1.5 sm:h-2 bg-sybo-surface rounded-full overflow-hidden">
                      <div className="h-full bg-sybo-mineral w-5/6 rounded-full animate-pulse"></div>
                    </div>
                    <div className="h-1.5 sm:h-2 bg-sybo-surface rounded-full overflow-hidden">
                      <div className="h-full bg-sybo-mineral w-3/5 rounded-full animate-pulse" style={{ animationDelay: '0.5s' }}></div>
                    </div>
                    <div className="h-1.5 sm:h-2 bg-sybo-surface rounded-full overflow-hidden">
                      <div className="h-full bg-sybo-mineral w-4/5 rounded-full animate-pulse" style={{ animationDelay: '1s' }}></div>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <div className="absolute bottom-6 sm:bottom-8 left-1/2 transform -translate-x-1/2 sybo-fade-in" style={{ animationDelay: '1s' }}>
          <div className="w-5 h-8 sm:w-6 sm:h-10 border-2 border-sybo-sapphire rounded-full flex justify-center cursor-pointer hover:border-sybo-neon transition-colors duration-300" onClick={() => scrollToSection('what-we-do')}>
